        ...
        if (sudoku != null && !Beans.isDesignTime()) {
            ...
            for (int i = 0; i < NUM_ROWS; i++) {
                for (int j = 0; j < NUM_COLUMNS; j++) {
                    ...
                    if (sudoku.isInInitialPuzzle(i, j))
            ...
            g.fillRect(CELL_SIZE * colSelected, CELL_SIZE * rowSelected, CELL_SIZE, CELL_SIZE);
            for (int i = 0; i <= NUM_ROWS; i++) {
                if (i % 3 == 0) {
            ...
            for (int i = 0; i < NUM_ROWS; i++) {
                for (int j = 0; j < NUM_COLUMNS; j++) {
                    String num = String.valueOf(sudoku.getValue(j, i));
                    g.setFont(new Font(Font.SANS_SERIF,Font.BOLD,24));
                    g.drawString(num,CELL_SIZE * i + CELL_SIZE/3, CELL_SIZE * (j +1) - CELL_SIZE/3);
                }
            }
        }
    }
        ...
        if (getRowSelected() != -1 && getColSelected() != -1) {
            if (evt.getKeyChar() >= '0' && evt.getKeyChar() <= '9') {
                ...
                if (sudoku.isFinished()) {
                    ...
                    ResourceBundle BUNDLE = ResourceBundle.getBundle("src/english");
                    String msgLevelCompleted = BUNDLE.getString("level");
